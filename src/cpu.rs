...
bitflags! {
    pub struct CpuFlags: u8 {
        ...
        const INTERUPT_DISABLE  = 0b00000100;
...
pub trait Mem {
    ...
    fn mem_read_u16(&self, pos: u16) -> u16 {
        ...
        // Combine the high byte (shifted 8 bits left) and low byte using bitwise OR to form a 16-bit value
        (hi << 8) | (lo as u16)
    }
        ...
        F: FnMut(&mut CPU),
    {
        ...
        loop {
            ...
            match code {
                ...
                //CLI
                0x58 => self.status.remove(CpuFlags::INTERUPT_DISABLE),
                //CLV
                ...
                //SEI
                0x78 => self.status.insert(CpuFlags::INTERUPT_DISABLE),
                //SED
                0xf8 => self.status.insert(CpuFlags::INTERUPT_DISABLE),
                //PHA
                ...
                //NOP
                0xea => {
                    //just increments the program counter
                }
                //TAY
                0xa8 => {
